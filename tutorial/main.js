...
const tutorial = {
    'board/0': () => {
        ...
        barBottom.innerHTML = '<b>Sun Player</b><br>Marks: GFEDCBA<br>Scales: 0123456';
        drawText(3, 3.15, 0.8, color, '🌞');

        const marks = 'GFEDCBA';

        for (var i = 0; i < 7; i++) {
            drawText(6.6, 6 - i, fontSize, color, i.toString());
    ...
    'board/1': () => {
        ...
        barBottom.innerHTML = '<b>Moon Player</b><br>Marks: ABCDEFG<br>Scales: 0123456';
        drawText(3, 3.15, 0.8, color, '🌜');
        ...
        for (var i = 0; i < 7; i++) {
            ...
            drawText(i + 0.5, 0, fontSize, color, marks[i]);
        }
    },
    'board/2': () => {
        barBottom.innerHTML = '<b>Yupana</b><br>Weights: 1235321<br>Scales: 0123456';
    ...
    'squares/0': () => {
        barBottom.innerHTML = '<b>Border</b><br>Squares in the border of the board.';
    ...
    'squares/1': () => {
        barBottom.innerHTML = '<b>Middle</b><br>Squares in the middle of the board.';

        drawRect(1, 1, 5, 2, hoverColor);
        drawRect(1, 3, 2, 1, hoverColor);
        drawRect(4, 3, 2, 1, hoverColor);
        drawRect(1, 4, 5, 2, hoverColor);

        drawRect(3, 3, 1, 1, boardColor);
    },
    'squares/2': () => {
        barBottom.innerHTML = '<b>Center & Peak</b><br>Square in the center of the board, also known as the mountain peak.';
